    ...
    <div class="shop_middle_logo_area">
        <div class="container">
            <div class="shop_middle_inner">
                <div class="shop_logo">
                    <a href="/move/main"><img src="/resources/img/clients-logo/shop-logo/shop-logo-6.png" alt=""></a>
                </div>
                ...
                <div class="shop_cart">
                    <div class="shop_cart_inner">
                        ...
                        <a class="cart_icon" href="#"><img src="/resources/img/icon/s-bag-icon.png" alt=""></a>
                        <%--<a href="#">$ 3 215.99</a>--%>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-5">
                <div class="product_flex_slider">
                    <div id="slider_p" class="flexslider">
                        <ul class="slides">
                            <li>
                                <img src="/resources/img/product/product-details/product-3.jpg" alt="">
                            </li>
                            <li>
                                <img src="/resources/img/product/product-details/product-3.jpg" alt="">
                            </li>
